...
{
    /// <inheritdoc />
    public partial class AddDailyQuiz : Migration
    {
        /// <inheritdoc />
        ...
        {
            migrationBuilder.DropTable(name: "DailyQuizOptions");
            migrationBuilder.DropTable(name: "DailyQuizAnswers");
            migrationBuilder.DropTable(name: "DailyQuizzes");
        }
    }
}
